...
<Info>
  **New in v2.0.2** — MCPB One-Click Bundle Support (`.mcpb`), Streamlined 7 Fluent Domain Tools (`sites_list`, `analytics_query`, `seo_audit`, etc.), Parallel Fetch Engine (`engine: "all"` for 50%+ faster queries), 100% Backward Compatibility, PageSpeed API key support, and 2026 Google Search Algorithm Updates! [Learn more →](/concepts/backward-compatibility)
</Info>
