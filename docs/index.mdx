...
<Info>
  **New in v1.14** — PageSpeed API key support (raises quota from ~100 to 25,000/day) and 2026 Google Search Algorithm Updates! [Learn more →](/getting-started/authentication#5-pagespeed-insights-optional-api-key)
</Info>
